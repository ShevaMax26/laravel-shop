          ...
          <div class="d-lg-block d-none">
            <div class="row g-0 position-relative">
              <div class="col-lg-3 d-flex align-items-center justify-content-center border-rit ">
                <div class="logo"> <router-link :to="{name: 'main'}"> <img src="/assets/images/logo/logo.png" alt=""> </router-link></div>
              </div>
                      ...
                      <div class=" d-flex align-items-center justify-content-between ">
                        ...
                        <div class="right d-flex align-items-center justify-content-end">
                          <ul class="main-menu__widge-box d-flex align-items-center ">
                            ...
                            <li class="cartm">
                                <a href="#" disabled class="number cart-icon">
                                    <i class="flaticon-shopping-cart"></i>
      ...
      <div class="side-cart d-flex flex-column justify-content-between">
        <div class="top">
          <div class="content d-flex justify-content-between align-items-center">
            <h6 class="text-uppercase">Your Cart ({{ this.products.length }})</h6> <span class="cart-close text-uppercase">X</span>
          </div>
          <div v-for="product in products">
            <div class="items d-flex justify-content-between align-items-center">
              <div class="left d-flex align-items-center">
                ...
                <div class="text">
                    <router-link :to="{name: 'products.show', params: {id: product.id}}"><h6>{{ product.title }}</h6></router-link>
                    <p>{{ product.qty }} X <span>${{ product.price * product.qty}}</span> </p>
                </div>
              </div>
              <div class="right">
