                  ...
                  <div class="single-sidebar-box mt-30 wow fadeInUp animated">
                    ...
                    <ul class="color-option">
                      <li v-for="color in filterList.colors">
                        <a href="#0" @click.prevent="addColor(color.id)" class="color-option-single"  :class="{'rounded-circle': colors.includes(color.id)}" :style="`background: #${color.title}`"><span>{{ color.title }}</span> </a>
                      </li>
                    </ul>
                  </div>
                  <div class="single-sidebar-box mt-30 wow fadeInUp animated">
                  ...
                  <div class="single-sidebar-box mt-30 wow fadeInUp animated pb-0 border-bottom-0 ">
                    ...
                    <ul class="popular-tag">
                      <li v-for="tag in filterList.tags">
                        <a href="#0" @click.prevent="addTag(tag.id)" :style="{ background: tags.includes(tag.id) ? '#f69c63' : '' }">{{ tag.title }}</a>
                      </li>
                                ...
                                <div class="row justify-content-between align-items-center">
                                  ...
                                  <div class="col-lg-6">
                                    <div class="popup-right-content">
                                      ...
                                      <div class="price">
                                        <h2 v-if="popupProduct.old_price"> ${{ popupProduct.price }} USD
                                          <del> ${{ popupProduct.old_price }} USD</del>
                                        </h2>
                                        <h2 v-else class="text-dark">${{ popupProduct.price }} USD</h2>
<!--                                        <h6> In stuck</h6>-->
                                      </div>
                            ...
                            <div class="products-three-single-content text-center"> <span>{{ product.category.title }}</span>
                              ...
                              <p v-if="product.old_price" style="color: #f69c63">
                                <del >${{ product.old_price }}</del>
                                ${{ product.price }}
                              </p>
                              <p v-else style="color: black">${{ product.price }}</p>
                            </div>
                          </div>
                        </div>
                      </div>
