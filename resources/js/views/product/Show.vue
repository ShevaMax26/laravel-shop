              ...
              <div class="single-product-box one">
                ...
                <div class="navholder">
                  <div class="product-slicknav single-product-one-nav slider-nav">
                    <div v-for="productImage in product.product_images">
                      <span class="single-item"> <img :src="productImage.url" alt=""></span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="shop-details-top-right ">
                <div class="shop-details-top-right-content-box">
                  ...
                  <div class="shop-details-top-price-box">
                    <h3>${{ product.price.toFixed(2) }} <del v-if="product.old_price">${{ product.old_price.toFixed(2) }}</del></h3>
                  </div>
                  ...
                  <div class="shop-details-top-color-sky-box">
                    ...
                    <ul class="varients">
                      <li v-for="groupProduct in product.group_products">
                        <a @click.prevent="getProduct(groupProduct.id)" v-for="color in groupProduct.colors" href="#0" :style="`background: #${color.title};`" style="width: 60px; height: 60px;" class="color-name" ></a>
                      </li>
                    </ul>
                  </div>
                  ...
                  <p class="shop-details-top-product-delivery">This product estimated delivery 1  - 2 days</p>
